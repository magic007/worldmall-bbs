...
0
|| checktplrefresh('./template/yesmmc_N3BSK2vfZ0FtHwIb/forum/ajax.htm', './template/yesmmc_N3BSK2vfZ0FtHwIb/common/header_ajax.htm', 1378776903, '8', './data/template/7_8_forum_ajax.tpl.php', './template/yesmmc_N3BSK2vfZ0FtHwIb', 'forum/ajax')
|| checktplrefresh('./template/yesmmc_N3BSK2vfZ0FtHwIb/forum/ajax.htm', './template/yesmmc_N3BSK2vfZ0FtHwIb/common/footer_ajax.htm', 1378776903, '8', './data/template/7_8_forum_ajax.tpl.php', './template/yesmmc_N3BSK2vfZ0FtHwIb', 'forum/ajax')
;?>
<?php ob_end_clean();
ob_start();
@header("Expires: -1");
