...
<div id="attach_preview_<?php echo $attach['aid'];?>_menu"  style="display:none">
<img src="<?php echo getforumimg($attach['aid'], 1, 300, 300, 'fixnone'); ?>&ramdom=<?php echo random(5); ?>" id="image_<?php echo $attach['aid'];?>" cwidth="<?php if($attach['width'] < 300) { ?><?php echo $attach['width'];?><?php } else { ?>300<?php } ?>"/>
</div>
