...
0
|| checktplrefresh('./template/yesmmc_N3BSK2vfZ0FtHwIb/forum/forumdisplay_fastpost.htm', './template/yesmmc_N3BSK2vfZ0FtHwIb/common/seditor.htm', 1375694677, '8', './data/template/7_8_forum_forumdisplay_fastpost.tpl.php', './template/yesmmc_N3BSK2vfZ0FtHwIb', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/yesmmc_N3BSK2vfZ0FtHwIb/forum/forumdisplay_fastpost.htm', './template/yesmmc_N3BSK2vfZ0FtHwIb/common/seccheck.htm', 1375694677, '8', './data/template/7_8_forum_forumdisplay_fastpost.tpl.php', './template/yesmmc_N3BSK2vfZ0FtHwIb', 'forum/forumdisplay_fastpost')
;?>
...
<label><input type="checkbox" name="adddynamic" value="1" <?php if($_G['forum']['allowfeed'] && !$_G['tid'] && empty($_G['forum']['viewperm'])) { ?>checked="checked"<?php } ?> />转播给听众</label>
<?php } ?>
</p>
</form>
</div>
