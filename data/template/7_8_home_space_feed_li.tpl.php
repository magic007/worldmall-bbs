...
<a class="t" href="home.php?mod=space&amp;uid=<?php echo $_GET['uid'];?>&amp;do=home&amp;view=<?php echo $_GET['view'];?>&amp;appid=<?php echo $value['appid'];?>&amp;icon=<?php echo $value['icon'];?>" title="只看此类动态"><img src="<?php echo $value['icon_image'];?>" /></a>
