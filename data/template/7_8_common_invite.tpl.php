...
<form method="post" autocomplete="off" name="invite" id="inviteform" action="misc.php?mod=invite&amp;action=<?php echo $_GET['action'];?>&amp;id=<?php echo $_GET['id'];?><?php if($_GET['activity']) { ?>&amp;activity=1<?php } ?>">
