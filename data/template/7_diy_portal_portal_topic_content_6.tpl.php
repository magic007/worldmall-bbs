...
0
|| checktplrefresh('data/diy/./template/default//portal/portal_topic_content_6.htm', './template/yesmmc_N3BSK2vfZ0FtHwIb/common/header.htm', 1375777543, 'diy', './data/template/7_diy_portal_portal_topic_content_6.tpl.php', 'data/diy/./template/default/', 'portal/portal_topic_content_6')
|| checktplrefresh('data/diy/./template/default//portal/portal_topic_content_6.htm', './template/yesmmc_N3BSK2vfZ0FtHwIb/common/footer.htm', 1375777543, 'diy', './data/template/7_diy_portal_portal_topic_content_6.tpl.php', 'data/diy/./template/default/', 'portal/portal_topic_content_6')
|| checktplrefresh('data/diy/./template/default//portal/portal_topic_content_6.htm', './template/yesmmc_N3BSK2vfZ0FtHwIb/common/header_common.htm', 1375777543, 'diy', './data/template/7_diy_portal_portal_topic_content_6.tpl.php', 'data/diy/./template/default/', 'portal/portal_topic_content_6')
;
block_get('98,94,96,97,95,99');?>
...
<style id="diy_style" type="text/css">#portal_block_96 {  margin:0px !important;}#portal_block_96 .dxb_bc {  margin:0px !important;}#portal_block_97 {  margin:0px !important;}#portal_block_97 .dxb_bc {  margin:0px !important;}</style>
<div id="widgets">
</div>
<div id="shortcut">
...
<div class="wp">
<!--[diy=diypage]--><div id="diypage" class="area"><div id="frameR21l4N" class="frame move-span cl frame-1"><div id="frameR21l4N_left" class="column frame-1-c"><div id="frameR21l4N_left_temp" class="move-span temp"></div><?php block_display('98');?></div></div><div id="frame8t4MT8" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">波点是一种潮流</span></div><div id="frame8t4MT8_left" class="column frame-1-c"><div id="frame8t4MT8_left_temp" class="move-span temp"></div><?php block_display('94');?></div></div><div id="frameU3kz65" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">波点包推荐</span></div><div id="frameU3kz65_left" class="column frame-1-c"><div id="frameU3kz65_left_temp" class="move-span temp"></div><?php block_display('96');?></div></div><div id="framegDq1yF" class="frame move-span cl frame-1"><div class="frame-title title"><span class="titletext">波点--时尚的跨界革命</span></div><div id="framegDq1yF_left" class="column frame-1-c"><div id="framegDq1yF_left_temp" class="move-span temp"></div><?php block_display('97');?></div></div><div id="framedTl8CU" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">草间弥生设计LV波点包背景故事</span></div><div id="framedTl8CU_left" class="column frame-1-c"><div id="framedTl8CU_left_temp" class="move-span temp"></div><?php block_display('95');?></div></div><div id="framezuUxOy" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">世界窗波点包推荐</span></div><div id="framezuUxOy_left" class="column frame-1-c"><div id="framezuUxOy_left_temp" class="move-span temp"></div><?php block_display('99');?></div></div></div><!--[/diy]-->
