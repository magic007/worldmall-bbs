<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('portal_topic_content_5');
0
|| checktplrefresh('data/diy/./template/default//portal/portal_topic_content_5.htm', './template/yesmmc_N3BSK2vfZ0FtHwIb/common/header.htm', 1375750362, 'diy', './data/template/7_diy_portal_portal_topic_content_5.tpl.php', 'data/diy/./template/default/', 'portal/portal_topic_content_5')
|| checktplrefresh('data/diy/./template/default//portal/portal_topic_content_5.htm', './template/yesmmc_N3BSK2vfZ0FtHwIb/common/footer.htm', 1375750362, 'diy', './data/template/7_diy_portal_portal_topic_content_5.tpl.php', 'data/diy/./template/default/', 'portal/portal_topic_content_5')
|| checktplrefresh('data/diy/./template/default//portal/portal_topic_content_5.htm', './template/yesmmc_N3BSK2vfZ0FtHwIb/common/header_common.htm', 1375750362, 'diy', './data/template/7_diy_portal_portal_topic_content_5.tpl.php', 'data/diy/./template/default/', 'portal/portal_topic_content_5')
;
block_get('90,91,92,93');?>
...
<style id="diy_style" type="text/css">#portal_block_93 {  margin:0px !important;}#portal_block_93 .dxb_bc {  margin:0px !important;}#portal_block_91 {  margin:0px !important;}#portal_block_91 .dxb_bc {  margin:0px !important;}#portal_block_92 {  margin:0px !important;}#portal_block_92 .dxb_bc {  margin:0px !important;}#portal_block_90 {  margin:0px !important;}#portal_block_90 .dxb_bc {  margin:0px !important;}</style>
<div id="widgets">
</div>
<div id="shortcut">
...
<div class="wp">
<!--[diy=diypage]--><div id="diypage" class="area"><div id="frame1" class="frame move-span frame-1 cl"><div id="frame1_left" class="column frame-1-c"><div id="frame1_left_temp" class="move-span temp"></div><?php block_display('90');?><?php block_display('91');?><?php block_display('92');?><?php block_display('93');?></div></div></div><!--[/diy]-->
