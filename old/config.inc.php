...
// [CH] 以下变量请根据空间商提供的账号参数修改,如有疑问,请联系服务器提供商
	...
	$dbuser = 'discuz_dbuser';			// 数据库用户名
	$dbpw = 'Wm#Db(DiS)';				// 数据库密码
	$dbname = 'discuz';			// 数据库名
...
define('UC_DBUSER', 'ucenter_dbuser');
define('UC_DBPW', 'Wm#Db(UCus)');
define('UC_DBNAME', 'ucenter');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`ucenter`.uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', '53ybw1L671D6z376Q24dZ9r6o9w6u332r4O0t1N0a0b0Teo4i8gdP6YdY6PfU5be');
define('UC_API', 'http://ucenter.worldmall.cn');
define('UC_CHARSET', 'utf-8');
define('UC_IP', '124.172.243.212');
define('UC_APPID', '1');
define('UC_PPP', '20');