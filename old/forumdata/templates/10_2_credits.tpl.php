...
0
|| checktplrefresh('/var/local/worldmall/bbs.worldmall.cn/./templates/default/credits.htm', '/var/local/worldmall/bbs.worldmall.cn/./templates/default/header.htm', 1330018315, '2', './templates/colors')
|| checktplrefresh('/var/local/worldmall/bbs.worldmall.cn/./templates/default/credits.htm', '/var/local/worldmall/bbs.worldmall.cn/./templates/default/faq_navbar.htm', 1330018315, '2', './templates/colors')
|| checktplrefresh('/var/local/worldmall/bbs.worldmall.cn/./templates/default/credits.htm', '/var/local/worldmall/bbs.worldmall.cn/./templates/default/footer.htm', 1330018315, '2', './templates/colors')
|| checktplrefresh('/var/local/worldmall/bbs.worldmall.cn/./templates/default/credits.htm', '/var/local/worldmall/bbs.worldmall.cn/./templates/default/jsmenu.htm', 1330018315, '2', './templates/colors')
;?>
...
<?=$pluginhooks['global_header']?><div id="nav"><a href="<?=$indexname?>"><?=$bbname?></a> &raquo; <? if(empty($action)) { ?>帮助<? } else { ?><a href="faq.php">帮助</a> <?=$navigation?><? } ?> &raquo; 积分说明</div>
