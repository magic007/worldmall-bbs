...
$forumselect = '<select id="forums" name="forums" onchange="getthreadtypes(this.value, 0)">'.forumselect(FALSE, 0, 0, TRUE).'</select>';
$portalselect = category_showselect('portal', 'portal', FALSE);
$blogselect = category_showselect('blog', 'blog', TRUE);
